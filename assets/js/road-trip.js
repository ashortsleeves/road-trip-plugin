...
window.onload = function() {
  ...
  var trailFilter = function() {
    ...
    for(var i=0; i < checkedArray.length; i++) {
      ...
      for(var o=0; o < filteredStarps.length; o++) {
        ...
        if(filteredStops.includes(filteredStarps[o])) {
          // console.log(filteredStarps[o].outerText+": "+countInArray(filteredStorps, filteredStarps[o]));
        }
    ...
    // if(arrayEquals(filteredMeta, metafiltersArray)) {
    //
    // } else {
    //   hideme = document.getElementsByClassName("filtered-destination");
    //
